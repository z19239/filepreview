...
<!-- begin -->
<#--<div id="topTitleMask" style="width: 100%;height:80px;background-color: rgba(128,128,128,0.8);
position: absolute;"
class="blur">
</div>
<div id="topTitle" style="width: 100%;height:80px;background-color: rgba(255,255,255,0.6);position: absolute;">
</div>-->
...
<div id="formbackground" class="carousel slide carousel-fade" style="position:fixed; z-index:-1;width: 100%;height:100%;" data-ride="carousel" data-interval="4000">
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img id="pic001" src="images/bg1.jpg" style="width: 100%;height: 100%;" alt="First slide">
		...
		<div class="item">
			<img id="pic003" src="images/bg3.jpg" style="width: 100%;height: 100%;" alt="Third slide">
			<p class="little_title">
				<span>全功能分享</span><br>
				&nbsp;&nbsp;&nbsp;<span>随时随地 随传随到</span>
			</p>
		...
		<div class="login" style="margin-top: 0px">
			...
			<form action="#" method="post" class="container offset1 loginform"
				...
				<div class="form-actions">
					<a <#--id="forget_pw"--> data-toggle="modal" data-target="#forget_pw" tabindex="5" class="btn pull-left btn-link text-muted">忘记密码?</a>
