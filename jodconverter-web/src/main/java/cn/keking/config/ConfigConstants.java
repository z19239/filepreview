...
public class ConfigConstants {
    ...
    public  static String EasyExcelTitle = "";
    ...
    public static String getSmbIp() {
        return SMB_IP;
    }
    public static void setSmbIp(String smbIp) {
        SMB_IP = smbIp;
    }
    ...
    public static void setSmbUsername(String smbUsername) {
    ...
    public static String getSmbFilePath() {
    ...
    @Value("${easyExcelTitle}")
    public void setEasyExcelTitle(String easyExcelTitle) {
        setEasyExcelTitles(easyExcelTitle);
    }
    public static void setEasyExcelTitles(String easyExcelTitle) {
        EasyExcelTitle = easyExcelTitle;
    }
}
